  ...
  String searchId=null;	
            ...
            throws IOException, ServletException 
	{
		...
		{	
			...
			if(searchId==null)	
			{
				System.out.println("The searchId is null");
			...
			System.out.println("Started Complete");
				if (!searchId.equals("")) 
				{
					System.out.println("The searchId is not null");
			...
			if (action.equals("lookup"))
			{
				...
				if ((searchId != null) && data.containsKey(searchId.trim().toLowerCase())) 
				{
					System.out.println("searchId is not null");
					request.setAttribute("data",data.get(searchId.trim().toLowerCase()));	
