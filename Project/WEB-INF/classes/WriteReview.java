      ...
      // on filling the form and clicking submit button user will be directed to submit review page
		...
		pw.print("</td></tr>");		
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
					...
					pw.print("<td> <input type='text' name='productmaker'> </td>");
			        pw.print("</tr>");
					
					pw.print("<tr>");
					pw.print("<td> Store Name: </td>");
					pw.print("<td> <input type='text' name='storeName'> </td>");
			        pw.print("</tr>");		
					...
					pw.print("<td> <input type='text' name='onSale'> </td>");
			        pw.print("</tr>");		
					...
					pw.print("<tr>");
					pw.print("<td> Enter your age: </td>");
					pw.print("<td> <input type='text' name='userAge'> </td>");
			        pw.print("</tr>");		

					pw.print("<tr>");
					pw.print("<td> Enter your gender: </td>");
					pw.print("<td> <input type='text' name='userGender'> </td>");
			        pw.print("</tr>");		

					pw.print("<tr>");
					pw.print("<td> Enter your occupation: </td>");
