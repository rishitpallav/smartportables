...
public class Product {
	...
	public Product(String id,String name, double price, String image, String retailer,String condition,String type,double discount, int available, boolean onSale, boolean manufacturerRebate){
		this.id=id;
		this.name=name;
		this.price=price;
		this.image=image;
