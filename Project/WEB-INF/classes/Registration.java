...
public class Registration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else
		{
			...
			else
			{
				...
				MySqlDataStoreUtilities.insertUser(username,password,repassword,usertype, address);					
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>Add Address</h3></td><td><input type='text' name='address' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
